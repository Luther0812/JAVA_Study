...
public class TicTacToeServer_013 extends JFrame implements TicTacToeConstants_012{
	public static void main(String[] args){
		TicTacToeServer_013 frame = new TicTacToeServer_013();
	}
	
	public TicTacToeServer_013(){
		...
		try{
			...
			while(true){
				...
				jtaLog.append("Player 1's IP address" + player1.getInetAddress().getAddress() + '\n');
...
class HandleASession implements Runnable, TicTacToeConstants_012{
