...
public class ListPropertiesDemo_007 extends JApplet{
	...
	private JComboBox jcboSelectionMode = new JComboBox(new String[]{"SINGLE_SELECTION (0)", "SINGLE_INTERVAL_SELECTION (1)", "MULTIPLE_INTERVAL_SELECTION (2)"});
	private JLabel jlblStatus = new JLabel();
	
	public void ListPropertiesDemo_007(){
