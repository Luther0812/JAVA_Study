...
import Test_16.Chapter_Test_034.TimerListener;

import java.awt.*;
import java.awt.event.*;

public class Chapter_Test_035 extends JFrame{
	...
	public static void main(String[] args){
		Chapter_Test_035 frame = new Chapter_Test_035();
		frame.setTitle("Chapter_Test_035");
	...
	public Chapter_Test_035(){
		add(new NewPanel_035_1());
		...
		list = new boolean[26];
		s1 = "(Guess) Enter a letter in word " + temp.toString();
		...
		addKeyListener(new KeyAdapter(){
			public void keyPressed(KeyEvent e){
				...
				if(e.getKeyCode() == KeyEvent.VK_ENTER && T){
					flag = false;
					s1 = "";
					s2 = "";
					s3 = "";
				...
				if(e.getKeyCode() >= KeyEvent.VK_A && e.getKeyCode() <= KeyEvent.VK_Z){
					...
					if(s != ""){
						...
						if(!A){
							...
							if(count == 7){
								...
								s1 = "";
								s2 = "";
								s4 = "To Start Game, Please Enter ENTER";
								T = true;
								repaint();
							}
							A = false;
					...
					if(temp.toString().equals(word)){
						s1 = "";
						s2 = "";
						s4 = "To Continue Game, Please Enter ENTER";
						T = true;
						repaint();
					}
				}
	...
	class NewPanel_035_1 extends JPanel{
		protected void paintComponent(Graphics g){
			...
			g.drawString(s1, 100, 450);
			g.drawString(s2, 100, 480);
			g.drawString(s3, 100, 510);
			g.drawString(s4, 100, 540);
		}
	}
