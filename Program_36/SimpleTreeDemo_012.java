...
public class SimpleTreeDemo_012 extends JApplet{
	private JTree jTree1 = new JTree();
	private JTree jTree2 = new JTree(new String[]{"dog", "cow", "cat", "pig", "rabbit"});
	private Vector vector = new Vector(Arrays.asList(new Object[]{"red", "green", "black", "white", "purple"}));
	...
	public SimpleTreeDemo_012(){
		...
		jcboShowRootHandles.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				boolean showsRootHandles = jcboShowRootHandles.getSelectedItem().equals("true");
